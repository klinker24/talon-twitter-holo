...
public class NotificationDrawerLayout extends ViewGroup {
    ...
    private ActionBarDrawerToggle mListener;
    ...
    public NotificationDrawerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NotificationDrawerLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        try {
            final boolean interceptForDrag = isDrawerOpen(Gravity.RIGHT) ? mRightDragger.shouldInterceptTouchEvent(ev) :
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void removeCallbacks() {
            NotificationDrawerLayout.this.removeCallbacks(mPeekRunnable);
        }
