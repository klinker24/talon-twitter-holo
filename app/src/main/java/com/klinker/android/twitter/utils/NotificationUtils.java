...
import com.klinker.android.twitter.activities.compose.NotificationCompose;
import com.klinker.android.twitter.activities.compose.NotificationComposeSecondAcc;
import com.klinker.android.twitter.activities.compose.NotificationDMCompose;
import com.klinker.android.twitter.activities.tweet_viewer.NotiTweetPager;
    ...
    public static void makeFavsNotification(ArrayList<String[]> tweets, Context context, boolean toDrawer) {
        ...
        if (settings.notifications) {
            ...
            if(context.getSharedPreferences("com.klinker.android.twitter_world_preferences",
                    0).getBoolean("pebble_notification", false)) {
