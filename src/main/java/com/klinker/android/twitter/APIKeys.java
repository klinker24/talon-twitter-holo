...
public class APIKeys {
     ...
     */
    public static String TWITTER_CONSUMER_KEY = "Dr4Cyw7SNtVEQ00YrvNmRmbtv";
    public static String TWITTER_CONSUMER_SECRET = "18zM2BjV1O5qlRZA9nfwrvTSMOgxSx92To5RpmKjxC6oAIOqBA";
